...
fn parse(input: &str) -> Option<Range<usize>> {
...
mod tests {
    ...
    #[test]
    fn test_part1() {
        assert_eq!(part1(111111..111111 + 1), 1);
        assert_eq!(part1(223450..223450 + 1), 0);
        assert_eq!(part1(123789..123789 + 1), 0);
    }

    #[test]
    fn test_part2() {
        assert_eq!(part2(112233..112233 + 1), 1);
        assert_eq!(part2(123444..123444 + 1), 0);
        assert_eq!(part2(111122..111122 + 1), 1);
    }
}
